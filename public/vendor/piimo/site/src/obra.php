       ...
       <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <img src="img/obra/piimo-obra-por-administracao.png" alt="" class="img-fluid">
                ...
                <div class="col-md-7">
                    ...
                    <p>Uma outra grande vantagem deste modelo é a flexibilidade na personalização das unidades. O projeto pode ser modificado, seguindo normas técnicas da construtora, de forma a se adaptar de maneira exclusiva as necessidades de cada cliente.</p>
                    ...
                    <div class="text-center">
                        <a href="#" class="btn btn-success btn-lg" role="button" data-toggle="modal" data-target="#modalObra">Quero um atendimento exclusivo</a>
                    </div>
          ...
          <div class="modal-body">
           ...
           <p class="h3 text-center">Deixe seus dados que, em breve, entraremos em contato.</p>
            ...
            <form id="form-obra" class="form-vertical" method="post" action="">
                ...
                <button type="submit" class="btn btn-success btn-block text-uppercase"><i class="icon-paper-plane-o"></i> Enviar</button>    
