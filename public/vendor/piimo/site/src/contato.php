                    ...
                    <ul class="contato-list">
                        ...
                        <li class="contato-list-title contato-icon-share-alt">
                            ...
                            <ul>
                                ...
                                <li><a href="https://www.linkedin.com/company/piimoempreendimentos/" target="_blank"><i class="icon-linkedin-square"></i> /piimoempreendimentos</a></li>
                            </ul>
                        </li>
                ...
                <div class="offset-md-1 col-md-5">
                    ...
                    <div class="form-div">
                        ...
                        <form id="form-contato" class="form-vertical" method="post" action="">
                            ...
                            <div class="row">
                                <div class="col-md-6 pr-md-1">
                                    <label for="email">Área pretendida:</label>
                                ...
                                <div class="col-md-6 pl-md-1">
                                    <label for="telefone">É cliente?</label>
                                    <select class="custom-select">
                            ...
                            <div class="row">
                                <div class="col-md-6 pr-md-1">
                                    <label for="email">Empreendimento:</label>
                                    <input type="text" name="empreendimento" class="form-control" placeholder="Digite sua cidade">
                                </div>
                                <div class="col-md-6 pl-md-1">
                                    <label for="telefone">Unidade:</label>
                                    <input type="text" name="unidade" class="form-control" placeholder="Digite seu bairro">
                                </div>
                            </div>
