...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-2 logo-div">
                    <a href="index.php">
                                                        <img src="img/piimo-logo.svg" alt="Piimo - Empreendimentos Imobiliários" class="img-fluid"> </a>
                ...
                <div class="col-md-8 menu-list d-flex justify-content-center align-items-center">
                    <ul class="list-inline collapse d-md-block" id="collapseMenu">
                        ...
                        <li class="list-inline-item">
                            <a class="nav-link" href="obra.php">Obra por Administração</a>
                        </li>
                        <li class="list-inline-item">
                            d <a class="nav-link dropdown-toggle" href="#" role="button" id="dropdownMenuLink" aria-haspopup="true" aria-expanded="false">A Piimo</a>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" href="piimo.php">Institucional</a>
                                <a class="dropdown-item" href="venda.php">Apresente seu terreno</a>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4 footer-institucional"><img src="img/piimo-logo.svg" alt="Piimo - Empreendimentos Imobiliários" class="img-fluid logo-footer"><br><br>
                ...
                <div class="col-md-3 footer-section footer-section-empresa">
                    ...
                    <ul class="list-unstyled">
                        <li><i class="icon-caret-right"></i> <a href="piimo.php">A Piimo</a></li>
                        <li><i class="icon-caret-right"></i> <a href="venda.php">Apresente seu terreno</a></li>
                        <li><i class="icon-caret-right"></i> <a href="trabalhe.php">Trabalhe na Piimo</a></li>
                        <li><i class="icon-caret-right"></i> <a href="obra.php">Obra por administração</a></li>
                    </ul>
                </div>
            </div>
        </div>
